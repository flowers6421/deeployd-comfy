...
class WebSocketManager:
    ...
    async def connect(
        ...
        async with self._lock:
            ...
            logger.info(f"WebSocket connected: {client_id} (room: {room}, prompt: {prompt_id})")
    ...
    async def broadcast_to_prompt(self, prompt_id: str, message: Dict[str, Any]):
...
class ProgressTracker:
    ...
    async def start_execution(self, prompt_id: str, total_steps: int = 25):
        ...
        await self.ws_manager.broadcast_to_prompt(prompt_id, {
    ...
    async def send_queue_update(self, prompt_id: str, queue_position: int):
