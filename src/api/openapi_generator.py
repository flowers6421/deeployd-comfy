...
from src.api.generator import WorkflowAPIGenerator, Parameter as WorkflowParameter, ParameterType
...
class OpenAPIGenerator:
    ...
    def _create_example(self, parameters: List[WorkflowParameter]) -> Dict[str, Any]:
    ...
    def generate_full_spec(
        ...
        if workflows:
            for workflow_id, workflow in workflows.items():
                ...
                spec["paths"][path] = self.generate_workflow_schema(
        ...
        spec["paths"]["/api/status/{prompt_id}"] = {
            "get": {
